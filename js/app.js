(() => {
    ...
    function formSubmit() {
        ...
        async function formSubmitAction(form, e) {
            ...
            if (error === 0) {
                ...
                if (ajax) {
                    e.preventDefault();
                    const ajaxTelegram = form.getAttribute("data-ajax") === "telegram";
                    const formAction = form.getAttribute("action") ? form.getAttribute("action").trim() : "#";
                    const formMethod = form.getAttribute("method") ? form.getAttribute("method").trim() : "GET";
                    const formData = new FormData(form);
                    let response = null;
                    if (ajaxTelegram) {
                        let message = "<b>Заявка с сайта! Vivien Michell</b>\n\n";
                        formData.forEach(((value, key) => {
                            message += `<b>${key}:</b> ${value}\n`;
                        }));
                        const TOKEN = "7418936774:AAEhNDWM7ypZzyOyolB4Gt9WzPRC56pPwFs";
                        const CHAT_ID = "@PK_Message_Bott";
    ...
    function initSliders() {
        if (document.querySelector(".audio-slider")) new swiper_core_Swiper(".audio-slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            on: {
                slideChangeTransitionStart: function() {
                    const audioElements = document.querySelectorAll(".audio-slider__audio");
                    audioElements.forEach((audio => {
                        audio.pause();
                        const slide = audio.closest(".audio-slider__slide");
                        if (slide) slide.classList.remove("played");
                    }));
                }
            }
        });
    }
    const playButtons = document.querySelectorAll(".audio-slider__button");
    playButtons.forEach((button => {
        button.addEventListener("click", (() => {
            const slide = button.closest(".audio-slider__slide");
            const audioElement = slide.querySelector("audio");
    ...
    const videoList = [ {
        ...
        file: "files/videos/Disturbed - Down With The Sickness (Official Music Video).mp4"
    }, {
        title: "Disturbed - Stricken (Official Music Video) [4K UPGRADE]",
        file: "files/videos/Disturbed - Stricken (Official Music Video) [4K UPGRADE].mp4"
    }, {
        title: "Disturbed - The Night (Official Music Video)",
        file: "files/videos/Disturbed - The Night (Official Music Video).mp4"
    }, {
        title: "Disturbed - The Vengeful One (Official Music Video)",
        file: "files/videos/Disturbed - The Vengeful One (Official Music Video).mp4"
    }, {
        title: "NITA STRAUSS - Dead Inside (ft. David Draiman of Disturbed).mp4",
        file: "files/videos/NITA STRAUSS - Dead Inside (ft. David Draiman of Disturbed).mp4"
    } ];
    const videoListJson = JSON.stringify(videoList);
    new Playerjs({
        id: "video-player",
        file: videoListJson
    });
    const slides = [ {
        audioLink: "files/audio/Disturbed - Are You Ready [Official Music Video].mp3",
        title: "Are You Ready [Official Music Video]",
        posterImage: "img/audio-posters/music-pic-1.webp"
    }, {
        audioLink: "files/audio/Disturbed - Bad Man [Official Music Video].mp3",
        title: "Bad Man [Official Music Video]",
        posterImage: "img/audio-posters/music-pic-2.webp"
    }, {
        audioLink: "files/audio/Disturbed - Don t Tell Me (feat. Ann Wilson) [Official Music Video].mp3",
        title: "Don t Tell Me (feat. Ann Wilson) [Official Music Video]",
        posterImage: "img/audio-posters/music-pic-3.webp"
    }, {
        audioLink: "files/audio/Disturbed - Down With The Sickness (Official Music Video) [HD UPGRADE].mp3",
        title: "Down With The Sickness (Official Music Video)",
        posterImage: "img/audio-posters/music-pic-4.webp"
    }, {
        audioLink: "files/audio/Disturbed - No More [Official Music Video].mp3",
        title: "No More [Official Music Video]",
        posterImage: "img/audio-posters/music-pic-5.webp"
    }, {
        audioLink: "files/audio/Disturbed - The Vengeful One (Official Music Video) [4K UPGRADE].mp3",
        title: "The Vengeful One (Official Music Video) [4K UPGRADE]",
        posterImage: "img/audio-posters/music-pic-6.webp"
    }, {
        audioLink: "files/audio/Disturbed - Unstoppable [Official Music Video].mp3",
        title: "Unstoppable [Official Music Video]",
        posterImage: "img/audio-posters/music-pic-7.webp"
    }, {
        audioLink: "files/audio/Disturbed - Are You Ready [Official Music Video].mp3",
        title: "Are You Ready [Official Music Video]",
        posterImage: "img/audio-posters/music-pic-8.webp"
    }, {
        audioLink: "files/audio/Disturbed - Bad Man [Official Music Video].mp3",
        title: "Bad Man [Official Music Video]",
        posterImage: "img/audio-posters/music-pic-9.webp"
    }, {
        audioLink: "files/audio/Disturbed - Don t Tell Me (feat. Ann Wilson) [Official Music Video].mp3",
        title: "Don t Tell Me (feat. Ann Wilson) [Official Music Video]",
        posterImage: "img/audio-posters/music-pic-1.webp"
        ...
        audioLink: "files/audio/Disturbed - The Vengeful One (Official Music Video) [4K UPGRADE].mp3",
        title: "The Vengeful One (Official Music Video)",
        posterImage: "img/audio-posters/music-pic-1.webp"
    }, {
        audioLink: "files/audio/Disturbed - Unstoppable [Official Music Video].mp3",
        title: "Unstoppable [Official Music Video]",
    ...
    const sliderContainer = document.querySelector(".audio-slider__wrapper");
    slides.forEach((slide => {
        const slideElement = document.createElement("div");
        slideElement.classList.add("audio-slider__slide", "swiper-slide");
        slideElement.innerHTML = `\n  <div class="audio-slider__label"> <span>LISTEN prev</span> <span>LISTEN NOW</span> <span>LISTEN Next</span></div>\n  <div class="audio-slider__image">\n    <img src="${slide.posterImage}" alt="Image">\n    <button class="audio-slider__button" type="button">\n\n    </button>\n    <audio class="audio-slider__audio" src="${slide.audioLink}"></audio>\n  </div>\n  <h2 class="audio-slider__title">${slide.title}</h2>\n  `;
        sliderContainer.appendChild(slideElement);
    }));
    const script_playButtons = document.querySelectorAll(".audio-slider__button");
    script_playButtons.forEach((button => {
        button.addEventListener("click", (() => {
            const slide = button.closest(".audio-slider__slide");
            if (!slide.classList.contains("swiper-slide-active")) return;
            const audioElement = slide.querySelector(".audio-slider__audio");
            if (audioElement.paused) {
                audioElement.play();
                slide.classList.add("played");
            } else {
        ...
        const audioElement = button.closest(".audio-slider__slide").querySelector(".audio-slider__audio");
        audioElement.addEventListener("ended", (() => {
            swiper.slideNext();
            const activeSlide = document.querySelector(".swiper-slide-active");
            const nextAudioElement = activeSlide.querySelector(".audio-slider__audio");
            if (nextAudioElement) {
    ...
    const formLines = document.querySelectorAll(".form-contacts__item");
    formLines.forEach((el => {
        const formField = el.querySelector(".input");
        formField.classList.add("empty");
        ...
        formField.onchange = () => {
            if (!formField.value.trim()) {
                ...
                formField.classList.remove("empty");
                el.classList.remove("empty");
            }
        };
    }));
    function snakeCursor() {
        const canvas = document.querySelector(".snake-cursor");
        const ctx = canvas.getContext("2d");
        let canvasColor = "#a200fe";
        ...
        for (let i = 0; i < params.pointsNumber; i++) trail[i] = {
            x: pointer.x,
            y: pointer.y,
            dx: 0,
            dy: 0
        ...
        function update(t) {
            if (!mouseMoved) {
                pointer.x = (.6 + .1 * Math.cos(.01 * t) * Math.sin(.005 * t)) * window.innerWidth;
                pointer.y = (.6 + .2 * Math.cos(.005 * t) + .1 * Math.cos(.01 * t)) * window.innerHeight;
            }
